...
Worksheet 1 covers "The Content Industry" and all material from [Module 1: Communication](https://jentery.github.io/mdia200v6/#module-1-communication-four-sessions). Your response is due via Brightspace by Thursday, January 29th at 10am.
...
**Prompt 1**. Identify a self-employed content creator who has been harassed and faces or has faced toxic behaviours online. Now, find some content (such as a video, image, or podcast episode) they produced and copy the URL for it. Then use no more than 425 words, including terminology from the ["Content Industry"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694709) handout and any handout in [Module 1: Communication](https://jentery.github.io/mdia200v6/#module-1-communication-four-sessions), to explain how the content creator 1) protects themselves online and 2) addresses or anticipates toxic behaviours. As part of your response, please be sure to include 1) a description of the content, 2) the name of the platform where the content was published, 3) some attention data (such as the number of likes, views, and comments) for the content, 4) how the content creator monetizes and moderates content, 5) how the platform generates revenue from the content, and 6) what you learned about the labour and economy of the content industry from this exercise. Note: you should *not* select a content creator's entire channel, profile, or website. You should instead select a specific instance of content published by a content creator of your choice. Please include the content's URL or the content itself somewhere in your response. That way, we can access it. 

**Prompt 2**. Find an article published by a reputable website that contains an image of two or more people communicating. (Avoid stock images, including AI-generated ones.) Now, copy the URL for the article and then write alt text for that image of two or more people communicating. Next, use no more than 425 words, including terminology from the ["Acts of Communication"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694710) and ["Senses of Communication"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694711) handouts, to explain the critical decisions you made while using alt text to 1) describe the image's visual and nonverbal elements for someone else to hear and 2) account for where on the page the image appears in the article. Please be sure to include the following in your response: 1) the article's URL and 2) your alt text in quotation marks to distinguish it from the rest of your response. 

There is no encoding standard that restricts the length of alt text, but alt text should be succinct. For this exercise, we recommend fewer than 275 characters, which won't count toward your word limit.

**Prompt 3**. Spend a few minutes listening to [CFUV 101.9 FM](https://cfuv.uvic.ca/) and perusing their website. Then create 30-60 seconds of audio to communicate roughly the same message twice: first to a friend at UVic via a hypothetical voice message or memo (one-to-one) and second to all UVic students via a hypothetical CFUV radio transmission (one-to-many) that would air during an [actual CFUV show](https://cfuv.uvic.ca/shows/). Next, use no more than 425 words, including terminology from the ["Acts of Communication,"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694710) ["Means of Communication,"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694712) and ["Levels of Communication"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694713) handouts, to explain 1) the *obvious* differences between the two communications, 2) the *subtle* differences between the two communications, and 3) what you learned about context, media, and communication from this exercise. Don't forget to attach your audio file so we can access it. As part of your written response, we recommend identifying the actual CFUV show you had in mind while creating your hypothetical radio transmission.  

**Prompt 4**. Select an advertisement from the 21st century that you interpreted against the grain and then save it, record it, or copy the URL for it. Next, use no more than 425 words, including terminology from the ["Forms of Communication"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694714) and ["Models of Communication"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694715) handouts and any other handout in [Module 1: Communication](https://jentery.github.io/mdia200v6/#module-1-communication-four-sessions), to explain 1) the advertisement's intended message, 2) a context in which the message was encoded, 3) a context in which you decoded it, 4) your negotiated or opposing interpretation of it, 5) the kind of feedback you provided in response to it, 6) the form of communication you used to provide that feedback, and 7) what you learned about media, communication, and meaning-making from this exercise. Don't forget to attach or embed the advertisement so we can access it. We recommend selecting "deep cuts" for this response: that is, advertisements that don't appear at the top of search results for "controversial ads" or the like. That way, you're less likely to repeat what many other people already said about advertising and popular ads from the 21st century. 

**Prompt 5**. Use 30-90 seconds of video or audio to either record or depict two types of noise you've encountered in your everyday communications with other people. (Six types of noise are described in the "Examples" section of the ["Noise and Miscommunication"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694717) handout.) Then use no more than 425 words, including terminology from the ["Noise and Miscommunication"](https://bright.uvic.ca/d2l/le/lessons/431416/topics/3694717) handout and any other handout in [Module 1: Communication](https://jentery.github.io/mdia200v6/#module-1-communication-four-sessions), to share 1) the two types of noise you identified, 2) descriptions of the two noises, 3) how you personally experience each noise, 4) what each noise tells us about what people normally want or expect from communication, and 5) what you learned about noise and the desire for "perfect communication" from this exercise. Don't forget to attach your audio or video file so we can access it. 
